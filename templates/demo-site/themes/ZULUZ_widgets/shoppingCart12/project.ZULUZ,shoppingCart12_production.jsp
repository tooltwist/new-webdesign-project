...
<%@page import="tooltwist.ZULUZ.productionHelpers.ShoppingCartProductionHelper"%>
...
<!-- ********** INSERT HTML HERE ********** -->
<form id="shoppingCart" name="shoppingCart" method="post" action="/ttsvr/ZULUZ/images/Shopping Cart   MacMall.html">
						...
						<div class="floatL w673">
							<div class="shop_cart_topbg">
								<div class="scholder padL20 padT5">
									<img src="/ttsvr/ZULUZ/images/logoShopCart_167x31.gif" align="left">
								</div>
								<div class="certholder">
									<div class="floatL" style="padding-top: 5px; padding-right: 10px">
										<a target="_blank" href="https://www.scanalert.com/RatingVerify?ref=www.macmall.com"><img src="/ttsvr/ZULUZ/images/logo_mcafee_cert.jpg"></a>
									</div>
									<div class="floatL" style="padding-right: 10px">
										<a target="_blank" href="https://www.entrust.net/customer/profile.cfm?domain=www.macmall.com"><img src="/ttsvr/ZULUZ/images/logo_entrust_cert.jpg"></a>
									</div>
									<div class="floatL" style="padding-top: 5px">
										<a target="_blank" href="http://www.la.bbb.org/Business-Report/MacMall-62000011"><img src="/ttsvr/ZULUZ/images/logo_bbb_cert.jpg"></a>
									</div>
										...
										<% while (h.hasNext()) { %>
											...
											<tr>
												<td class="padiT10" valign="top" width="124" align="center">
													...
													</div> <img src="/ttsvr/ZULUZ/images/<%=h.getImage() %>.jpg" alt="itemManufacturer" onerror="javascript:this.src='/mall/widgetti/images/common/errorPage/na.gif'" style="width: 67px; height: 67px; cursor: pointer;" title="Click here to see a list of recommendations." onclick="selectEDP('7628871');">
												</td>
												...
												<td class="ftahoma padiT10" valign="top" width="278">
													...
													<div name="sr_catalogProductGridDiv" style="float: left;">
														<div class="sr_product_grid">
															<img src="/ttsvr/ZULUZ/images/Green_icon_18x15_Transparent.gif" alt="ShopRunner" border="0" class="sr_icon">
															<div class="sr_eligible_txt">ShopRunner Eligible</div>
														</div>
													</div>

													<div class="hcb4"></div> <span class="ftahoma fsize11 fgray">MacMall Part #: <%=h.getMacPart() %><a href="javascript:showAvailabilityLegend();"> <img id="availabilityImage_7628871" class="shopCart-availabilityImg" src="/ttsvr/ZULUZ/images/iconSun_20x20.gif" alt="">
												...
												<td valign="top" width="20" align="center" class="padiT10"><input type="image" onclick="deleteEDP('7628871');" src="/ttsvr/ZULUZ/images/btnTrashcan.jpg" class="shopCart-trashImg" alt="Delete" title="Delete"></td>
												...
												<div class="hcb4" style="height: 35px"></div> <input type="image" onclick="saveLaterEDP('7628871');" src="/ttsvr/ZULUZ/images/btnSaveForLater.gif" class="shopCart-trashImg" alt="Save For Later" title="Save For Later">
												</td>
											...
											<tr>
												<td colspan="7">
													<table cellpadding="0" cellspacing="0" width="100%" class="ftahoma" style="margin-top: 10px;">
														<tbody>
															<tr>
																<td align="right" width="70%"><input type="image" id="btnUpdate" src="/ttsvr/ZULUZ/images/btnUpdate_70x16.gif" onclick="return updateCart();"></td>
								...
								<div class="cart_sub_wrapinner">
									...
									<div align="center">
										<div class="ptsc_btnholder">
											<img src="/ttsvr/ZULUZ/images/btnProcessCheckout.jpg" class="shopCart-top" onclick="return checkOut();">
										</div>
									</div>
									...
									<p class="farial fsize12 txtAJ padT5">- or -</p>
									<div align="center">
										<img src="/ttsvr/ZULUZ/images/btnCheckoutPayPal_143x24.png" class="shopCart-top" onclick="return checkOutPP();">
									</div>
									...
									<div class="ftahoma padT10 hauto marginauto" style="width: 270px; width: 283px!ie;">
										<div style="padding-left: 7px!ie;">
											...
											<div class="floatL w31 marginL5">
												<input type="image" id="btnZipCodeGo" src="/ttsvr/ZULUZ/images/btnGo_29x21.gif" class="shopCart-top" onclick="return getShippingChoice();">
											</div>
